---
topic: webapplications-creating-records
description: Creating Salesforce records from the webapp — createRecord, custom/standard objects, id handling
---

# Creating Salesforce records (webapplications)
...
Use this knowledge when creating Salesforce records from a React BYO webapp (e.g. applications, leads, custom objects).
